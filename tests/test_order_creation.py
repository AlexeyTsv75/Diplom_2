...
class TestOrderCreation:
    @allure.title("Проверяем создание заказа с существующими ингредиентами у авторизованного пользователя")
    ...
    @allure.title("Проверяем создание заказа с существующими ингредиентами у неавторизованного пользователя")
